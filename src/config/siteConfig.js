  ...
  works: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: '输入文案一键生成动画视频，11种视觉风格(含3D猫/玄学/都市精英角色动画)，Canvas渲染+AI图片+阿里/MiniMax双TTS+声音复刻+MP4导出',
        icon: '🎬',
        color: '#d97706',
        ...
        enabled: true,
        category: 'ai-tools',
        features: ['React', 'Canvas', 'TTS', 'FFmpeg', 'VoiceClone'],
        images: [
          'https://placehold.co/600x340/d97706/ffffff?text=Content2Video',
          'https://placehold.co/600x340/b45309/ffffff?text=11+Visual+Styles',
          'https://placehold.co/600x340/92400e/ffffff?text=Voice+Clone+MP4',
        ],
      },
    ],
  },
